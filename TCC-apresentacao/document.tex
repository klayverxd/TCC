...
\begin{frame}{
    \begingroup 
        ...
        \begin{multicols}{2}
            ...
            \begin{figure}[H]
                \vspace*{-0.6cm}
                \includegraphics[width=1\linewidth]{figuras/passo1.pdf}
            \end{figure}
        \end{multicols}
    \endgroup
}
    ...
    \begin{itemize}
        ...
        \item Suporte a bancos de dados;
            \begin{itemize}
                ...
                \item SQL Server;
            \end{itemize}
        \item Suporte a ORM\footnote{\scriptsize Técnica de programação para a interação entre aplicações e banco de dados} nativo;
...
\begin{frame}{
    \begingroup 
        ...
        \begin{multicols}{2}
            ...
            \begin{figure}[H]
                \vspace*{-0.6cm}
                \includegraphics[width=1\linewidth]{figuras/passo2.pdf}
            \end{figure}
        \end{multicols}
    \endgroup
    }
...
\begin{frame}{
    \begingroup 
        ...
        \begin{multicols}{2}
            ...
            \begin{figure}[H]
                \vspace*{-0.6cm}
                \includegraphics[width=1\linewidth]{figuras/passo3.pdf}
            \end{figure}
        \end{multicols}
    \endgroup
}
...
\begin{frame}{
    \begingroup 
        ...
        \begin{multicols}{2}
            ...
            \begin{figure}[H]
                \vspace*{-0.6cm}
                \includegraphics[width=1\linewidth]{figuras/passo4.pdf}
            \end{figure}
        \end{multicols}
    \endgroup
}
    \begin{figure}[H]
        ...
        \includegraphics[width=1\linewidth]{figuras/fluxo-requisicoes-testes2.pdf}
        \captionsetup{justification=centering}
        \source{O autor.}
...
\begin{frame}{
    \begingroup 
        ...
        \begin{multicols}{2}
            ...
            \begin{figure}[H]
                \vspace*{-0.6cm}
                \includegraphics[width=1\linewidth]{figuras/passo5.pdf}
            \end{figure}
        \end{multicols}
    \endgroup
}
...
\begin{frame}{
    \begingroup 
        ...
        \begin{multicols}{2}
            ...
            \begin{figure}[H]
                \vspace*{-0.6cm}
                \includegraphics[width=1\linewidth]{figuras/passo6.pdf}
            \end{figure}
        \end{multicols}
    \endgroup
}
...
\begin{frame}{
    ...
    \end{table}
    \begin{itemize}
        \item Alternativas para o Node.js: Prisma, Sequelize e TypeORM;
        \item Alternativas para o .Net Core: Entity Framework Core e Dapper.
    \end{itemize}
\end{frame}
...
\begin{frame}{
    \begingroup 
        ...
        \begin{multicols}{2}
            ...
            \begin{figure}[H]
                \vspace*{-0.6cm}
                \includegraphics[width=1\linewidth]{figuras/passo6-teste.pdf}
            \end{figure}
        \end{multicols}
    \endgroup
}
    \begin{itemize}
        \item Todos os \textit{framework} oferecem suporte para a construção das APIs por meio da documentação;
        \vspace*{0.5em}
...
\begin{frame}{
    ...
    \begin{figure}[H]
        \centering
        \caption{Consumo médio de recursos - teste de carga crescente}
...
\begin{frame}{
    ...
    \begin{itemize}
        \item Foi observado, durante os testes práticos, que nenhum dos \textit{framework} demonstrou falhas nas requisições. Em todos os cenários avaliados, a taxa de erros de requisição foi igual a 0. Com estes resultados conclui-se que, para os cenários modelados, os \textit{frameworks} possuem bom rendimento.
    \end{itemize}
...
\begin{frame}{
    ...
    \begin{itemize}
        \item     \textbf{.Net apresentou um maior tempo de resposta inicial (cold start)}
    \end{itemize}
    \begin{figure}[H]
        \centering
        \caption{Inicialização do .Net no teste de carga crescente}
        \includegraphics[width=0.52\linewidth]{figuras/resultados/start-dotnet-crescente-ex2.pdf}
        \captionsetup{justification=centering}
        %\source{O autor.}
        \label{fig:endurance-tempo-metodos-totais}
    \end{figure}
...
\begin{frame}{}
    \centering
    \huge{
        \textbf{\example{Obrigado(a) pela Atenção!}
    }}

    \vspace{0.5cm}

    \huge{
        \textbf{\example{Dúvidas?}
    }}
